...
void php_midgard_config_init(int module_number);
...
void php_midgard_dbus_init(int module_number);
void php_midgard_replicator_init(int module_number);
void php_midgard_datetime_init(int module_number);
void php_midgard_error_init(int module_number);
void php_midgard_transaction_init(int module_number);
void php_midgard_view_init(int module_number);
void php_midgard_storage_init(int module_number);
void php_reflection_workaround_init(int module_number);
void php_midgard_key_config_context_init(int module_number);
void php_midgard_key_config_file_context_init(int module_number);
void php_midgard_key_config_init(int module_number);
void php_midgard_key_config_file_init(int module_number);
