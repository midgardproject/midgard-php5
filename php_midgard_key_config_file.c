...
static const gchar *class_doc_comment = "File based key-value (ini like) configurations";
...
void php_midgard_key_config_file_init(int module_numer)
{
	static function_entry midgard_key_config_file_methods[] = {
	...
	INIT_CLASS_ENTRY(
			php_midgard_key_config_file_class_entry,
			"midgard_key_config_file", midgard_key_config_file_methods);

	php_midgard_key_config_file_class =
		zend_register_internal_class_ex(
				&php_midgard_key_config_file_class_entry, NULL, "midgard_key_config" TSRMLS_CC);

	php_midgard_key_config_file_class->doc_comment = g_strdup(class_doc_comment);
