...
midgard.configuration_file = /home/pp/git/piotras/midgard-php5/tests/test.cfg
report_memleaks = On
--FILE--
<?php
...
$job2 = $manager->create_job(MIDGARD_CONTENT_MANAGER_JOB_DELETE, $content2, $reference2);
...
try {
	$content_copy = new midgard_snippetdir($content2->guid);
} catch (Exception $e) {
	// Do nothing
}
$content->purge(false);
